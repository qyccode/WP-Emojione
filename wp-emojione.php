 ...
 * Plugin URI: http://yawzhou.com/emojione/
 * Description: 给你的文章和页面添加更全的EmojiOne表情。
 * Version: 1.0.1
 * Author: 杳无宗
 * Author URI: http://yawzhou.com
 * Time: 2017.8.3
 * Thanks：leogg,Monchito.net
 * License: GPLv2
 * Text Domain: wp_emojione
 * Domain Path: /languages/
 */

/*  Copyright 2017 杳无宗 (email : admin@yawzhou.com)
...
defined('ABSPATH') or die("这里没有什么可看的！或者可以到我博客(yawzhou.com)喝杯茶吖！");
...
function wp_emojione_admin_footer(){
	...
	printf('%1$s by %2$s<br />', $wp_emojione_plugin_data['Title'].' '.$wp_emojione_plugin_data['Version'], $wp_emojione_plugin_data['Author'] . '<br>Emoji provided free by <a href="http://emojione.com" target="_blank">Emoji One</a>. And Thanks <a href="http://monchito.net" target="_blank">Monchito.net</a>.');
}
...
function wp_emojione_options_panel(){
		...
		<table class="form-table">
			<tr valign="top">
				...
				<?php _e("TinyMCE编辑器工具栏的", "wp_emojione") ?>
					...
					<p><small><?php _e("把EmojiOne按钮放在你想要的编辑器工具栏的行。", "wp_emojione") ?></small></p>
				</td>
			</tr>
		</table>
		<p class="submit">
	...
	<h3><?php _e("2. EmojiOne表情预览", 'wp_emojione') ?></h3>
	<p>
	<iframe width="300" height="350" scrolling="no" src="../wp-content/plugins/WP-EmojiOne/Emoji-Test.html"></iframe>
	</p>
	<h3><?php _e("3. 请我喝咖啡", 'wp_emojione') ?></h3>
	<p>
	<iframe width="320" height="210" scrolling="no" src="../wp-content/plugins/WP-EmojiOne/Reward.html"></iframe>
	</p>
	...
	<?php _e('MySQL版本：', 'wp_emojione') ?> <?php echo mysql_get_server_info(); ?><br />
	...
	<p>
	<?php _e("杳无宗", 'wp_emojione') ?> [ <a href="http://yawzhou.com" target="_blank">http://yawzhou.com</a> ] 
	</p>
	<p>
	<?php _e("如果你在使用过程中遇到什么问题或者有更好的建议, ", 'wp_emojione') ?><?php _e('请 <a href="http://yawzhou.com/guestbook" target="_blank">给我留言</a>！', 'wp_emojione') ?>
	</p>
	</div>
<?php } 
